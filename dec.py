...
def banner():
    print RR + '\n              Author : Aditia Alfiansyah' + WW + ' v.1'
    print W + '  ------------------------------------------'
    ...
    print W + '  ------------------------------------------'
    print '           \x1b[2;2m python2 ' + sys.argv[0] + ' --info\n' + W
...
def hash():
    ...
    if len(hash_str) == len(mysql1323) and hash_str.isdigit() == False and hash_str.isalpha() == False and hash_str.isalnum() == True:
        ...
        if cek == '1' and cek == '01' or cek == 'sha512':
            hash = 'sha512'
        elif cek == '2' and cek == '02' or cek == 'whirlpool':
            hash = 'whirlpool'
        else:
        ...
        cek = raw_input(B + '[' + W + '?' + B + '] ' + G + 'Choose Hash ' + Y + '>>> ' + W)
        if cek == '1' and cek == '01' and cek == 'md4' and cek == 'MD4' or cek == 'Md4':
            hash = 'md4'
        elif cek == '2' and cek == '02' and cek == 'md5' and cek == 'MD5' or cek == 'Md5':
        ...
        if cek == '03' and cek == '3' or cek.upper() == 'NTHASH':
            hash = 'nthash'
        elif cek == '04' and cek == '4' or cek.upper() == 'LMHASH':
            hash = 'lmhash'
        elif cek == '05' and cek == '5' or cek.upper() == 'NTLM':
            hash = 'ntlm'
        else:
            print R + '[' + W + '!' + R + '] ' + G + 'Exiting ... \n' + W
            sys.exit()
        ...
        cek = raw_input(B + '[' + W + '?' + B + '] ' + G + 'Choose Hash ' + Y + '>>> ' + W)
        if cek == '1' and cek == '01' and cek == 'sha1' and cek == 'SHA1' or cek == 'Sha1':
            print B + '[' + R + '=' + B + '] ' + G + 'open google'
            print B + '[' + W + '*' + B + '] ' + G + 'Start ...'
            start = '00:00:00'
            start1 = time.time()
        ...
        if cek == '2' and cek == '02' or cek == 'ripemd160':
            hash = 'ripemd160'
        else:
            print R + '[' + W + '!' + R + '] ' + G + 'Exiting ... \n' + W
            sys.exit()
